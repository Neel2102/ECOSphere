...
import { LuShield, LuDownload, LuSheet, LuFileText } from 'react-icons/lu';
...
function GovernanceReport() {
  ...
  const handleDownload = (format) => {
    const url = reportService.getReportDownloadUrl('governance', format, {
    ...
    <div>
      ...
      <div className="module-table-card">
        <div className="module-table-card__header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span className="module-table-card__title" style={{ display: 'flex', alignItems: 'center', gap: 8 }}><LuShield size={16} /> Compliance & Audits Logs</span>
